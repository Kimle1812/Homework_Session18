...
int main(){
	...
	struct Student st[50] = {
		{1, "Nguyen Thi Kim Le", 21, "0376113341"},
		{2, "Hoang Thai Minh", 18, "0376113341"},
		{3, "Nguyen Khac Hung", 18, "0376113341"},
		{4, "Ha Bich Ngoc", 18, "0376113341"},
		{5, "Ho Khanh Linh", 18, "0376113341"}
	};
